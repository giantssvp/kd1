...
namespace kd.Models
{
    ...
    public class DailyFollowup
    {
        ...
        public UInt32 Executive1_ID { get; set; }
        public UInt32 Executive2_ID { get; set; }
        public UInt32 Executive3_ID { get; set; }
    }
    public class DailyVM
    {
        public UInt32 ID { get; set; }
        public string Customer_Name { get; set; }
        public UInt32 Daily_Customer_ID { get; set; }
        public UInt32 Site_ID { get; set; }
